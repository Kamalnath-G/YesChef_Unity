...
1. Open the project in Unity 6000.4.12f1 (or any Unity 6000+).
2. Open `Assets/Scenes/Game Scene.unity` and enter Play Mode.
3. Press **Start** on the main menu. **WASD** to move, **E** to interact.
...
- **Order generation is uniformly random.** No weighting, no difficulty curve. A real version would ramp order complexity as the session progresses.
